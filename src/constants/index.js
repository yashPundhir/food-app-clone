...
import bg11 from "../assets/bg1.jpeg";
...
export const foodCategories = [
	{
		...
		name: "North Indian",
		description:
			"Delicious North Indian dishes like Butter Chicken, Naan, and Paneer.",
		image: bg1,
		dishes: [
			{
				id: 1,
			...
			},
			{
				id: 3,
				name: "Naan",
				description: "Soft and fluffy flatbread",
				price: "$2",
				image: "/src/assets/naan.jpg",
			},
			{
				id: 4,
				name: "Dal Makhani",
	...
	},
	{
		...
		name: "South Indian",
		description:
			"Savor South Indian delicacies such as Dosa, Idli, and Sambar.",
		image: bg1,
		dishes: [
			{
				id: 1,
				name: "Dosa",
				description: "Crispy rice pancake served with chutney",
				price: "$5",
	...
	},
	{
		...
		name: "Punjabi",
		description:
			"Enjoy hearty Punjabi meals including Chole Bhature, Dal Makhani, and Lassi.",
		image: bg3,
		dishes: [
			{
				id: 1,
				...
				price: "$9",
				image: "/src/assets/chole-bhature.jpg",
			},
			{
				id: 2,
				name: "Lassi",
	...
	},
	{
		...
		name: "Chinese",
		description:
			"Tasty Chinese food options like Noodles, Manchurian, and Spring Rolls.",
		image: bg4,
		dishes: [
			{
				id: 1,
				...
				price: "$7",
				image: "/src/assets/hakka-noodles.jpg",
			},
			{
				id: 2,
				name: "Manchurian",
				description: "Crispy fried veggie balls in a spicy sauce",
				price: "$8",
				image: "/src/assets/manchurian.jpg",
			},
			{
				id: 3,
				name: "Spring Rolls",
	...
	},
	{
		...
		dishes: [
			...
			{
				name: "Mix Veg Curry",
				description: "Curry with seasonal vegetables",
				price: "$9",
				image: "/src/assets/mix-veg.jpg",
			},
			// Add more dishes...
		],
	},
	{
		...
		name: "Non-Vegetarian",
		description:
			"Mouth-watering non-vegetarian dishes like Biryani, Kebabs, and Fish Curry.",
		image: bg6,
		dishes: [
			{
			...
			},
			{
				...
				price: "$12",
				image: "/src/assets/fish-curry.jpg",
			},
			{
				name: "Mutton Kebab",
				description: "Grilled spiced mutton skewers",
				price: "$15",
				image: "/src/assets/mutton-kebab.jpg",
			},
			// Add more dishes...
		],
	},
...
export const cartItemsTableColNames = [
	{
		key1: "Image",
		key2: "Name",
		key3: "Price",
...
export const cartItemsTableData = [
	{
		key1: bg11,
		key2: "Dummy Name",
		key3: "Rs. 300",
